...
var resizePizzas = function(size) {
    ...
    function changeSliderLabel(size) {
        ...
        switch (size) {
            case "1":
                ...
                return;
            case "2":
                pizzaSizeLabelText = "Medium";
                return;
            case "3":
                pizzaSizeLabelText = "Large";
                return;
            default:
    ...
    function changePizzaSizes(size) {
        var i,
            newWidth,
            randomPizzaBox = document.getElementsByClassName('randomPizzaContainer'),
            totalRandomPizzaBox = randomPizzaBox.length;
        ...
        for (i = 0; i < totalRandomPizzaBox; i++) {
...
function updatePositions() {
    ...
    var totalItems = items.length, // no of pizzas
        scrollPosition = document.body.scrollTop / 1250, // 1250 seems to effect speed
        sineArray = []; // stores scroll factor values

    // Adopted from https://gist.github.com/anonymous/dbddbb3cbe8ff64dffd3
    // gives five values only to be used in phase calulation
    for (var j = 0; j < 5; j++) {
...
// This starts the animation if ticking is false
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var s = 256;
    var elem;
    var totalPizzas = 60; // Aprroximate total pizza number value.
    var movingPizzasBox = document.getElementById('movingPizzas1');
    for (var i = 0; i < totalPizzas; i++) {
        ...
        elem.style.left = (i % cols) * s + 'px'; // gives 0, 256, 512, 768, 1024, 1280, 1536, 1792 in px
